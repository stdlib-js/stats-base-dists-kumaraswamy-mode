...
tape( 'if provided `a = 1` and `b = 1`, the function returns `NaN`', opts, function test( t ) {
	var y;
...
tape( 'if provided `a < 1`, the function returns `NaN`', opts, function test( t ) {
	var y;
...
tape( 'if provided `b < 1`, the function returns `NaN`', opts, function test( t ) {
	var y;
